...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='show_theme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='show_themes', to='planetarium.showtheme'),
        ),
        migrations.AddField(
            model_name='astronomyshow',
            name='speaker',
            field=models.ManyToManyField(blank=True, related_name='show_speakers', to='planetarium.speaker'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='reservation',
